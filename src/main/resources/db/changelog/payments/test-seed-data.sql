-- Test data for payments database (integration tests)

-- Test Case 1: Simple case with one service request, one fee, one payment (fully paid)
INSERT INTO payment_fee_link (id, date_created, date_updated, payment_reference, org_id, enterprise_service_name, ccd_case_number, case_reference)
...
INSERT INTO payment (id, amount, ccd_case_number, currency, date_created, date_updated, payment_channel, payment_method, payment_provider, payment_status, payment_link_id, reference)
VALUES (1, 100.00, '1000000000000001', 'GBP', '2024-01-15 10:00:00', '2024-01-15 10:00:00', 'online', 'card', 'gov pay', 'success', 1, 'RC-TEST-0001');

INSERT INTO fee_pay_apportion (id, payment_id, fee_id, payment_link_id, fee_amount, payment_amount, apportion_amount, ccd_case_number, apportion_type, date_created, date_updated)
...
INSERT INTO remission (id, fee_id, hwf_reference, hwf_amount, beneficiary_name, ccd_case_number, payment_link_id, date_created, date_updated)
...
INSERT INTO payment (id, amount, ccd_case_number, currency, date_created, date_updated, payment_channel, payment_method, payment_provider, payment_status, payment_link_id, reference, payer_name)
